...
angular.module('ionic-timepicker', ['ionic', 'ionic-timepicker.templates', 'pascalprecht.translate'])

// Defining `ionicTimepicker` directive
  .directive('ionicTimepicker', ['$ionicPopup', '$translate', function ($ionicPopup, $translate) {
    return {
      restrict: 'AE',
      replace: true,
      scope: {
